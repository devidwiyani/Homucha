...
public class ListStorageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else
        {
            ...
            {
                productAdapter = new ProductAdapter(ListStorageActivity.this,this, produk_id, kategori_id, produk_nama, produk_harga, produk_deskripsi, produk_gambar, cursor1);
                daftarPenyimpanan.setAdapter(productAdapter);
                daftarPenyimpanan.setLayoutManager(new LinearLayoutManager(this));
                GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2, GridLayoutManager.VERTICAL, false);
                daftarPenyimpanan.setLayoutManager(gridLayoutManager);
                daftarPenyimpanan.setHasFixedSize(true);
            }
    ...
    void storeDataInArrays(){
        Cursor cursor = database.readPenyimpanan();

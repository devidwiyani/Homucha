...
public class ListTableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else
        {
            ...
            {
                productAdapter = new ProductAdapter(ListTableActivity.this,this, produk_id, kategori_id, produk_nama, produk_harga, produk_deskripsi, produk_gambar, cursor1);
                daftarMeja.setAdapter(productAdapter);
                daftarMeja.setLayoutManager(new LinearLayoutManager(this));
                GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2, GridLayoutManager.VERTICAL, false);
                daftarMeja.setLayoutManager(gridLayoutManager);
                daftarMeja.setHasFixedSize(true);
            }
    ...
    void storeDataInArrays(){
        Cursor cursor = database.readMeja();

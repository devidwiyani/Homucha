...
public class ListChairActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else
        {
            ...
            {
                productAdapter = new ProductAdapter(ListChairActivity.this,this, produk_id, kategori_id, produk_nama, produk_harga, produk_deskripsi, produk_gambar, cursor1);
                daftarKursi.setAdapter(productAdapter);
                daftarKursi.setLayoutManager(new LinearLayoutManager(this));
                GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2, GridLayoutManager.VERTICAL, false);
                daftarKursi.setLayoutManager(gridLayoutManager);
                daftarKursi.setHasFixedSize(true);
            }
    ...
    void storeDataInArrays(){
        Cursor cursor = database.readKursi();

...
public class ListDecorationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else
        {
            ...
            {
                productAdapter = new ProductAdapter(ListDecorationActivity.this,this, produk_id, kategori_id, produk_nama, produk_harga, produk_deskripsi, produk_gambar, cursor1);
                daftarDekorasi.setAdapter(productAdapter);
                daftarDekorasi.setLayoutManager(new LinearLayoutManager(this));
                GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2, GridLayoutManager.VERTICAL, false);
                daftarDekorasi.setLayoutManager(gridLayoutManager);
                daftarDekorasi.setHasFixedSize(true);
            }
    ...
    void storeDataInArrays(){
        Cursor cursor = database.readDekorasi();

...
public class ListFurnitureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else
        {
            ...
            {
                productAdapter = new ProductAdapter(ListFurnitureActivity.this,this, produk_id, kategori_id, produk_nama, produk_harga, produk_deskripsi, produk_gambar, cursor1);
                daftarFurnitur.setAdapter(productAdapter);
                daftarFurnitur.setLayoutManager(new LinearLayoutManager(this));
                GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2, GridLayoutManager.VERTICAL, false);
                daftarFurnitur.setLayoutManager(gridLayoutManager);
                daftarFurnitur.setHasFixedSize(true);
            }
    ...
    void storeDataInArrays(){
        Cursor cursor = database.readFurnitur();
